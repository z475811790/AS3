package com.message {
	...
	public dynamic final class S_ChatMsg extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const DATE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.message.S_ChatMsg.date", "date", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, this.date);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 3:
					...
					++date$count;
					this.date = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				default:
